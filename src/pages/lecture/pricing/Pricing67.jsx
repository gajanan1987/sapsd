        ...
        <div className="card purple">
          ...
          <table className="table-reponsive">
            ...
            <tbody>
              <tr>
                <td>
                  What does the "Statistics" checkbox mean for a pricing
                  procedure step?
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  There is no flag in the customer master — it's purely
                  determined by which condition records (e.g. Customer+Material)
                  you choose to maintain in VK11
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  Otherwise it won't be sellable/orderable in those channels —
                  the order will fail
                </td>
              </tr>
              <tr>
