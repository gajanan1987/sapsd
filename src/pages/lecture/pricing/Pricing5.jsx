import "../../../style/Lect/pricing5.scss";
const Pricing5 = () => {
  return (
      ...
      <div className="container">
        ...
        <div className="card red">
          ...
          <p>
            ...
            condition types, use a single <strong>Common Discount</strong>{" "}
            condition type with its own access sequence — so only the most
            relevant one wins.
          </p>
          <div className="callout blue">
            🏢 <strong>Real-world note:</strong> In practice, a company
            configures <em>either</em> individual discounts <em>or</em> a common
            discount — never both together (since that reintroduces the stacking
            problem). The unused option's condition type is marked{" "}
        ...
        <div className="card cyan">
          ...
          <div className="callout red">
            🔒 Since real businesses use <em>either</em> individual <em>or</em>{" "}
            common discounts (never both), go back to the 4 individual discount
            condition types (P004, P005, P007, P020) in the pricing procedure
            and check <strong>"Manual"</strong> — this stops them from
            auto-applying, so only the Common Discount (PCOM) takes effect.
          </div>
        </div>
        ...
        <div className="card green">
          ...
          <table className="table-reponsive">
            ...
            <tr>
              ...
              <td>
                Customer record found first (most specific) → stops immediately,
                ignores price group 7%, cust/material 3%, material 2%
              </td>
            </tr>
            <tr>
              <td>100553</td>
        ...
        <div className="card">
          ...
          <div className="stepper">
            <div className="step">
              Go to order → <strong>Header</strong> →{" "}
              <strong>Conditions</strong> tab (not the line item conditions)
            </div>
            <div className="step">
        ...
        <div className="card purple">
          ...
          <table className="table-reponsive">
            ...
            <tr>
              ...
              <td>
                A field controlling how the value is computed — A = Percentage,
                B = Fixed Amount, etc.
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                be entered manually, and gets distributed proportionally across
                all line items — unlike line-item discounts which apply per
                material/customer via condition records
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                Can a company use both individual and common discounts together?
              </td>
              <td>
            ...
            <tr>
              <td>Where must a discount step sit in the pricing procedure?</td>
              <td>
        ...
        <div className="card gold">
          ...
          <table className="table-reponsive">
            ...
            <tr>
              ...
              <td>
                62 (HB00), 63 (HA00), both From 20, Manual checked, Account Key
                ERS
              </td>
            </tr>
          </table>
