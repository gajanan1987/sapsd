    ...
    <div className="lecture-common">
      ...
      <div className="container">
        ...
        <div className="card orange">
          ...
          <p>
            Defined using T-code <span className="tcode">V/03</span>{" "}
            &nbsp;|&nbsp; Menu path:{" "}
            <code>
        ...
        <div className="card purple">
          ...
          <p>
            Defined using T-code <span className="tcode">V/07</span>{" "}
            &nbsp;|&nbsp; Menu path:{" "}
            <code>
              SPRO → Sales and Distribution → Basic Functions → Pricing →
        ...
        <div className="card green">
          ...
          <div className="legend">
            ...
            <span>
              <span className="tag tag-distributor">P2 - Distributor</span> 9700
            </span>
            <span>
              <span className="tag tag-institution">P3 - Institution</span> 9600
            </span>
            <span>
