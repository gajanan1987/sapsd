  ...
  return (
    <>
      ...
      <div class="container">
        ...
        <div class="card">
          <h2>
            <span class="badge">1</span> The Big Picture
          </h2>
          <p>
          ...
          <div class="flow">
            <div class="flow-step">Condition Records</div>
            <div class="arrow">➜</div>
            <div class="flow-step">Condition Tables</div>
            <div class="arrow">➜</div>
            <div class="flow-step">Access Sequence</div>
            <div class="arrow">➜</div>
            <div class="flow-step">Condition Types</div>
            <div class="arrow">➜</div>
            <div class="flow-step">Pricing Procedure</div>
          </div>
        ...
        <div class="card teal">
          <h2>
            <span class="badge">2</span> Condition Records
          </h2>
          <ul>
            <li>
            ...
            <li>
              Maintained using T-code <span class="tcode">VK11</span>
            </li>
          </ul>
        </div>
        ...
        <div class="card orange">
          <h2>
            <span class="badge">3</span> Condition Table
          </h2>
          <p>
          ...
          <p>
            Defined using T-code <span class="tcode">V/03</span> &nbsp;|&nbsp;
            Menu path:{" "}
            <code>
        ...
        <div class="card purple">
          <h2>
            <span class="badge">4</span> Access Sequence
          </h2>
          <div class="callout">
          ...
          <p>
            Defined using T-code <span class="tcode">V/07</span> &nbsp;|&nbsp;
            Menu path:{" "}
            <code>
              SPRO → Sales and Distribution → Basic Functions → Pricing →
          ...
          <table>
            ...
            <tr>
              <td>🥇 Most Specific</td>
              <td>
                <span class="tag tag-special">Customer + Material</span>
              </td>
            ...
            <tr>
              <td>🥈 Middle</td>
              <td>
                <span class="tag tag-dealer">Price List + Material</span>
              </td>
            ...
            <tr>
              <td>🥉 Most General</td>
              <td>
                <span class="tag tag-direct">Material only</span>
              </td>
        ...
        <div class="card purple">
          <h2>
            <span class="badge">👀</span> Sneak Peek: Condition Types & Pricing
            Procedure
          </h2>
          <p style="font-size:0.9em; color:#6b7280;">
          ...
          <h3 style="color:var(--navy); margin-bottom:6px;">Condition Type</h3>
          <ul>
            <li>
            ...
            <li>
              Defined using T-code <span class="tcode">V/06</span>
            </li>
            <li>
              Common standard examples:
              <div class="legend" style="margin-top:8px;">
                <span class="tag tag-special">PR00 – Base Price</span>
                <span class="tag tag-dealer">K004 – Material Discount</span>
                <span class="tag tag-distributor">
                  K005 – Customer/Material Discount
                </span>
                <span class="tag tag-institution">KF00 – Freight</span>
                <span class="tag tag-direct">MWST – Output Tax</span>
              </div>
            </li>
          </ul>

          <h3 style="color:var(--navy); margin-bottom:6px;">
            Pricing Procedure
          </h3>
          <ul>
            <li>
            ...
            <li>
              Defined using T-code <span class="tcode">V/08</span>
            </li>
            <li>
        ...
        <div class="card green">
          <h2>
            <span class="badge">5</span> Worked Example
          </h2>
          <p>
          ...
          <div class="legend">
            <span>
              <span class="tag tag-special">Special Customer</span> 9500
            </span>
            <span>
              <span class="tag tag-dealer">P1 - Dealer</span> 9800
            </span>
            <span>
              <span class="tag tag-distributor">P2 - Distributor</span> 9700
            </span>
            <span>
              <span class="tag tag-institution">P3 - Institution</span> 9600
            </span>
            <span>
              <span class="tag tag-direct">Material only</span> 10,000
            </span>
          </div>
          ...
          <table>
            ...
            <tr>
              <td>100551</td>
              <td>
                <span class="tag tag-special">Special + Institution</span>
              </td>
              <td>—</td>
            </tr>
            <tr>
              <td>100552</td>
              <td>
                <span class="tag tag-special">Special + Distributor</span>
              </td>
              <td>—</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>100555</td>
              <td>
                <span class="tag tag-distributor">Distributor</span>
              </td>
              <td>P2</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>100557</td>
              <td>
                <span class="tag tag-institution">Institution</span>
              </td>
              <td>P3</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>100560</td>
              <td>
                <span class="tag tag-special">Special + Direct</span>
              </td>
              <td>—</td>
            </tr>
          </table>
        ...
        <div class="card gold">
          <h2>
            <span class="badge">✅</span> Exclusive CHECKED (Normal Practice)
          </h2>
          ...
          <table>
            ...
            <tr>
              <td>100557</td>
              <td class="price-final">9600</td>
              <td>Price List P3</td>
            </tr>
            <tr>
              <td>100558</td>
              <td class="price-final">10,000</td>
        ...
        <div class="card red">
          <h2>
            <span class="badge">⚠️</span> Exclusive UNCHECKED
          </h2>
          ...
          <table>
            ...
            <tr>
              <td>100551</td>
              <td>
                <span class="price-strike">9500</span> →{" "}
                <span class="price-strike">9600</span> → 10,000
              </td>
              <td class="price-final">10,000</td>
            </tr>
            <tr>
              ...
              <td>
                <span class="price-strike">9500</span> →{" "}
                <span class="price-strike">9700</span> → 10,000
              </td>
              <td class="price-final">10,000</td>
            </tr>
            <tr>
              <td>100553</td>
              <td>
                <span class="price-strike">9800</span> → 10,000
              </td>
              <td class="price-final">10,000</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>100560</td>
              <td>
                <span class="price-strike">9500</span> → 10,000
              </td>
              <td class="price-final">10,000</td>
            </tr>
          </table>
          <p style="font-size:0.9em; color:#6b7280;">
            📌 Notice: with Exclusive unchecked, the system <em>always</em>{" "}
            reaches the most general "Material only" combination — so 10,000
            wins in every single case here.
          </p>
        </div>
        ...
        <div class="card teal">
          <h2>
            <span class="badge">🧩</span> Edge Cases & Extra Scenarios
          </h2>

          <h3 style="color:var(--navy); margin-bottom:6px;">
            1. What if NO condition record is found anywhere?
          </h3>
          <p>
          ...
          <h3 style="color:var(--navy); margin-bottom:6px;">
            3. What if a condition record has a validity period?
          </h3>
          <p>
            Condition records maintained via <span class="tcode">VK11</span>{" "}
          ...
          <h3 style="color:var(--navy); margin-bottom:6px;">
            4. Manually changing price in the sales order
          </h3>
          <p>
          ...
          <h3 style="color:var(--navy); margin-bottom:6px;">
            5. New pricing / re-pricing
          </h3>
          <p>
            If master condition records change <em>after</em> an order is
            created, the order keeps its old price unless the user manually
            triggers <strong>"New Pricing"</strong> (Update Pricing) in the
            order — SAP does not auto-refresh prices retroactively.
          </p>
        </div>
        ...
        <div class="card purple">
          <h2>
            <span class="badge">❓</span> Important Interview Questions &
            Answers
          </h2>
          <table>
            <tr>
            ...
            <tr>
              ...
              <td>
                Master data for pricing, also called Condition Master / Pricing
                Master; maintained via VK11
              </td>
            </tr>
            <tr>
              <td>What is a Condition Table?</td>
              <td>
                A combination of fields used to store/maintain condition records
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                When checked, the system stops searching as soon as it finds the
                first valid record; when unchecked, it searches all combinations
                and activates only the last one found
              </td>
            </tr>
            <tr>
              <td>
        ...
        <div class="card teal">
          <h2>
            <span class="badge">🔢</span> Important Transaction Codes & Purpose
          </h2>
          <table>
            <tr>
              <th>T-Code</th>
            ...
            <tr>
              <td>
                <span class="tcode">VK11</span>
              </td>
              <td>Maintain Condition Records (create)</td>
            </tr>
            <tr>
              <td>
                <span class="tcode">V/03</span>
              </td>
              <td>Define/Create Condition Tables</td>
            </tr>
            <tr>
              <td>
                <span class="tcode">V/07</span>
              </td>
        ...
        <div class="card gold">
          <h2>
            <span class="badge">⚙️</span> Important Configuration Topics &
            Values
          </h2>
          <table>
            <tr>
        ...
        <div class="card">
          <h2>
            <span class="badge">⭐</span> Best Practice & Next Class
          </h2>
          <div class="callout green">
