import "../../../style/Lect/pricing4.scss";
const Pricing4 = () => {
  return (
      ...
      <div className="container">
        ...
        <div className="card gold">
          ...
          <p>
            ...
            procedure <code>PVAA01</code> → double-click{" "}
        ...
        <div className="card teal">
          <h2>
            <span className="badge">6</span> Step 5 — Define & Maintain Price
            Groups (Master Data)
          </h2>
        ...
        <div className="card green">
          ...
          <table className="table-reponsive">
            ...
            <tr>
              <td>
                <span className="tag tag-material">P004</span> Material Discount
              </td>
            ...
            <tr>
              <td>
                <span className="tag tag-custmat">P005</span> Customer/Material
                Discount
              </td>
              <td>Quantity-based (₹ per unit)</td>
          ...
          <div className="callout blue">
            ...
            behavior is controlled at the <strong>condition type level</strong>{" "}
            and can be changed there, or overridden manually on each record
            (e.g., set to end of current year).
          </div>
        ...
        <div className="card">
          ...
          <div className="callout purple">
            ...
            typically configured as <strong>independent condition types</strong>{" "}
            in the pricing procedure — so <em>multiple</em> discounts can apply
            simultaneously to the same order line, each contributing its own
            deduction.
          </div>
        </div>
        ...
        <div className="card purple">
          ...
          <table className="table-reponsive">
            ...
            <tr>
              <td>
                Why reuse condition tables for discounts instead of creating new
                ones?
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                All discounts are calculated as a percentage/amount off the Base
                Value (step 20), not off each other
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                A customer categorization (dealer/distributor/institution) used
                for price group discounts; maintained in Customer Master → Sales
                tab
              </td>
            </tr>
          </table>
