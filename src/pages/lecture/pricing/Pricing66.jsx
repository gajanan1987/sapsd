    ...
    <div className="lecture-common">
      ...
      <div className="container">
        ...
        <div className="card teal">
          ...
          <p>
            Condition table names always start with prefix
            <strong>A</strong> followed by the table number — e.g., table number
            <code>676</code> → technical table name <code>A676</code>.
          </p>
        ...
        <div className="card purple">
          ...
          <div className="stepper">
            ...
            <div className="step">
              ...
              <strong>Fields</strong> (confirms/activates the field mapping)
            </div>
            <div className="step">
          ...
          <div className="callout green">
            ...
            normal
            <strong>Customizing Request</strong> instead.
          </div>
        </div>
        ...
        <div className="card purple">
          ...
          <table className="table-reponsive">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  Why assign a condition type in Pricing Procedure
                  Determination?
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  That field becomes mandatory when maintaining condition
                  records
                </td>
              </tr>
              <tr>
          ...
          <table className="table-reponsive">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Change Condition Tables (also used to assign package if saved
                  as Local Object)
                </td>
              </tr>
              <tr>
                ...
                <td>
                  Display Condition Tables (used to verify cross-client update
                  in client 810)
                </td>
              </tr>
              <tr>
          ...
          <table className="table-reponsive">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Sales Org P100, Document Pricing Proc A, Customer Pricing Proc
                  1
                </td>
              </tr>
              <tr>
        ...
        <div className="card green">
          ...
          <ul>
            ...
            <li>
              Field sequence when creating tables is
              <strong>mandatory</strong> (must match the logical
